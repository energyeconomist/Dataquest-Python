# Mission 3: Lists and For Loops

# In this mission, I created a list of data points and a list of lists. 
# I also retrieved an element of a list and multiple list elements of a list.
# I learned how to open different kind of files and repeat a process using a for loop.
