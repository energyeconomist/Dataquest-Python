# In this mission, I learned to answer more granular questions by combining conditional statements and clauses (if, else, elif) 
# with logical operators (and, or) and comparison operators (==, !=, >, >=, <, <=).
