# In this mission, I learned about dictionaries and focused on how to use them to build frequency tables.
# I learned that the dictionary values can be of any data type: strings, integers, floats, Booleans, lists and even dictionaries.
# Dictionary keys, on the other hand, can be of almost any data type except for lists and dictionaries.
# Frequency tables are common in data analytics/science practice and I am sure I will use them quite fruquently down the road.
